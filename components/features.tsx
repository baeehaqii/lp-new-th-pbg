import { ShieldCheck, Trees, CarFront, CircleMinus } from "lucide-react"
  ...
  return (
    <section id="fasilitas" className="features-section">
      <div className="container">
        <h2 className="section-title">Rumah Nyaman di Jantung Purbalingga</h2>
        <p className="section-subtitle">
          Strategis untuk Tinggal Sekaligus Investasi
        </p>
