...
export default function Hero() {
  ...
  const heroSlides = [
    {
      image: "https://res.cloudinary.com/dqobwse9q/image/upload/v1754883070/rend_10_iscnhv.png",
      title: "Purbalingga Center Point",
      description:
        "Mudah menjangkau semua fasilitas publik.",
    },
    {
      image: "https://res.cloudinary.com/dqobwse9q/image/upload/v1754883071/rend_14_szzp54.png",
      title: "Rumah Nyaman di Jantung Purbalingga",
      description: "Bersebelahan dengan hotel bintang empat, di kawasan yang terus berkembang.",
    },
    {
      image: "https://res.cloudinary.com/dqobwse9q/image/upload/v1754883070/rend_10_iscnhv.png",
      title: "Nilai Terus Naik, Hidup Makin Baik",
      description: "Hunian strategis yang menguntungkan untuk investasi.",
    },
  ]
